...
clear HofU cs2 PofU UofP dPofUdrho0 dPofUdu cs2cgs SofU dSofUdrho0 dSofUdu PofCHI dPofCHIdrho0 dPofCHIdchi qmofU tkofU;
...
for p=1:ntdyn
    for o=1:nhcm
        for n=1:nuout
            for m=1:nrhob
                fprintf(fid,'%3d %3d %3d %3d %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g %21.15g', ...
                m-1, n-1, o-1, p-1, ...
                ...
                qmofUout(m,n,o,p),tkofUout(m,n,o,p));
                fprintf(fid,'\n');
            end
        end
    end
